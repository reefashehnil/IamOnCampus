...
.chat-container { max-width: 800px; margin: 20px auto; background: white; border-radius: 8px; display: flex; flex-direction: column; height: 85vh; overflow: hidden; box-shadow: 0 0 10px rgba(0,0,0,0.1); }
.chat-header { padding: 10px; background: #1877f2; color: white; font-weight: bold; display: flex; align-items: center; gap: 10px; }
...
.me .bubble { background: #0084ff; color: white; border-radius: 18px 18px 0 18px; padding: 10px; display: inline-block; }
.them { align-self: flex-start; text-align: left; }
.them .bubble { background: #e4e6eb; border-radius: 18px 18px 18px 0; padding: 10px; display: inline-block; }
.sender-name { font-size: 0.8rem; color: gray; margin-bottom: 2px; }
.seen-status { font-size: 0.8rem; color: gray; margin-top: 3px; }
.chat-input { display: flex; padding: 10px; border-top: 1px solid #ccc; }
.chat-input input { flex: 1; border-radius: 20px; border: 1px solid #ccc; padding: 10px; }
.chat-input button { background: #1877f2; color: white; border: none; border-radius: 50%; width: 40px; height: 40px; margin-left: 5px; }
</style>
</head>
<body>
