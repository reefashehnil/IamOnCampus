...
<h2 class="text-center mb-4" style="color: #e0c3fc; font-weight: 600;">
    <i class="fas fa-user-circle me-2" style="color: #8a2be2;"></i>Welcome Back
</h2>
...
<div class="text-center">
    <p style="margin: 0; color: #ffffff;">
        ...
        <a href="register.php" style="color: #8a2be2; text-decoration: none; font-weight: 600;">
