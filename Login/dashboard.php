...
<head>
    ...
    <style>
        ...
        .sidebar {
            width: 250px; background: #2a2a40; padding: 20px; height: 100vh; position: fixed; top: 0; left: 0;
            transition: transform 0.3s ease; box-shadow: 2px 0 10px rgba(0, 0, 0, 0.5); z-index: 1000;
            display: flex; flex-direction: column; justify-content: space-between;
        }
        .sidebar.hidden { transform: translateX(-250px); }
        .sidebar .brand { font-size: 24px; font-weight: 700; color: #a855f7; text-align: center; margin-bottom: 30px; }
        .sidebar .nav-link { color: #e0e0e0; padding: 12px 15px; border-radius: 8px; display: flex; align-items: center; gap: 10px; transition: background 0.2s ease, color 0.2s ease; text-decoration: none; }
        .sidebar .nav-link:hover, .sidebar .nav-link.active { background: #a855f7; color: #fff; }
        .sidebar .dropdown-menu { background: #2a2a40; border: 1px solid #4b0082; border-radius: 8px; width: 200px; margin-left: 10px; }
        .sidebar .dropdown-item { color: #e0e0e0; padding: 10px 15px; }
        .sidebar .dropdown-item:hover { background: #a855f7; color: #fff; }
        .sidebar .footer { text-align: center; padding: 20px 0; color: #b0b0c0; font-size: 0.95rem; border-top: 1px solid #4b0082; }
        .main-content { margin-left: 250px; padding: 30px; flex-grow: 1; transition: margin-left 0.3s ease; }
        .main-content.full { margin-left: 0; }
        .hero-section {
            background: linear-gradient(145deg, #2a2a40 0%, #1a1a2e 100%);
            border-radius: 16px; padding: 40px; text-align: center; box-shadow: 0 6px 20px rgba(0, 0, 0, 0.4); margin-bottom: 30px;
        }
        .hero-section h1 { font-size: 2.5rem; font-weight: 700; color: #c084fc; margin-bottom: 10px; }
        .hero-section p { font-size: 1.1rem; color: #b0b0c0; margin-bottom: 20px; }
        .hero-section .btn-explore { background: #a855f7; color: #fff; padding: 10px 20px; border-radius: 25px; font-weight: 600; text-decoration: none; transition: background 0.3s ease; }
        .hero-section .btn-explore:hover { background: #9333ea; }
        .toggle-sidebar { position: fixed; top: 20px; left: 20px; background: #a855f7; color: #fff; border: none; padding: 10px; border-radius: 8px; cursor: pointer; z-index: 1100; display: none; }
        /* Carousel styles */
        .carousel-wrap { background: #1f1f35; border: 1px solid #3a3a58; border-radius: 16px; padding: 20px; box-shadow: 0 6px 20px rgba(0,0,0,.25); }
        .carousel-title { font-weight: 700; color: #c084fc; margin: 0 0 14px; text-align: center; }
        .story-card {
            background: #2a2a40; border: 1px solid #3a3a58; border-radius: 16px; padding: 25px; width: 350px;
            box-shadow: 0 8px 18px rgba(0,0,0,.35);
        }
        .story-card:nth-child(1) { background-color: #6B46C1; } /* Deep purple for first card */
        .story-card:nth-child(2) { background-color: #805AD5; } /* Medium purple for second card */
        .story-card:nth-child(3) { background-color: #4C51BF; } /* Deep blue for third card */
        .story-card .avatar { width: 80px; height: 80px; border-radius: 9999px; object-fit: cover; border: 2px solid #7c3aed; }
        .story-card .name { font-weight: 700; color: #eae7ff; margin-top: 12px; margin-bottom: 4px; }
        .story-card .user-id { color: #a78bfa; font-size: 0.9rem; margin: 0 0 8px; }
        .story-card .about {
                        ...
                        <div class="d-flex justify-content-center gap-3 flex-wrap">
                            ...
                            <div class="story-card">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <div class="name"><?php echo $name ?: 'Student'; ?></div>
